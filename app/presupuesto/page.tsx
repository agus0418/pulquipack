    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20 md:py-28 relative overflow-hidden flex items-center">
        ...
        <div className="relative w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-8 text-shadow-sm">Solicite su Presupuesto</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <InfoBadge icon={CheckCircle} text="Respuesta en 24hs" />
            <InfoBadge icon={Shield} text="Información confidencial" />
            <InfoBadge icon={FileText} text="Sin compromiso" />
          </div>
        </div>
      </section>
